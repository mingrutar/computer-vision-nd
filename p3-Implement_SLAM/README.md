# Landmark Detection & Robot Tracking (SLAM) for 2D

## Project Overview

This is Udacity Computer Vision Nanodegree project 3, the last and most chalenging project because the course only taught us 1D SLAM.

In this project, implement SLAM (Simultaneous Localization and Mapping) for a 2 dimensional world! Combine what you know about robot sensor measurements and movement to create a map of an environment from only sensor and motion data gathered by a robot, over time. SLAM gives us a way to track the location of a robot in the world in real-time and identify the locations of landmarks such as buildings, trees, rocks, and other world features. This is an active area of research in the fields of robotics and autonomous systems. 
